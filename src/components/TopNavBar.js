    ...
    <>
      ...
      <div className="flex flex-row h-20 items-center justify-between px-4 md:px-6 lg:px-9">
        ...
        <div className="flex flex-row items-center gap-4">
          ...
          />
          <button className="block md:hidden w-12 h-12 mx-4 text-xl pb-0.5 leading-none text-light-100 rounded-full bg-primary-400 hover:bg-primary-500 shadow transition-all">
            <PlusOutlined />
          </button>
