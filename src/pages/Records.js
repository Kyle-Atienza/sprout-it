        ...
        <div className="flex flex-col w-full lg:w-5/6 min-h-screen" id="top">
          ...
          <div className="overflow-x-auto harvests-table mx-10 my-6 shadow-md bg-light-100 rounded-xl">
            <div className="flex">
              ...
              <div className="active flex items-center gap-5">
                <p className="whitespace-nowrap">Active from</p>
                <input
                  className="sblock w-full p-4 pl-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                  type="month"
                  name="active"
                  onChange={onChangeFilter}
                  data-active="min"
